...
from saas_app.beta.models import Invite
from saas_app.beta.forms import InviteForm
...
def check_invite(request):
    ...
    raise ImmediateHttpResponse(response=redirect(reverse("beta:request-invite")))
